...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="text-[10px] font-semibold uppercase tracking-wider text-black/30 dark:text-white/30 pt-2">
      {children}
    </div>
  )
}
      ...
      <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
        <div className="flex-1 overflow-y-auto">
          <div className="px-4 py-4 space-y-3">
            ...
            {/* --- Schedule (only for schedule triggers) --- */}
            {hasSchedule && (
              <>
            ...
            <div className="space-y-1.5">
              <div className="text-xs font-medium text-black/60 dark:text-white/60 block">Skills</div>
              <button
                type="button"
